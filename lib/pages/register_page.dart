...
class _RegisterPageState extends State<RegisterPage> {
  ...
  final GlobalKey<FormState> additionalPreferencesformKey =
      GlobalKey<FormState>();
  ...
  final TextEditingController foodPreferenceController =
      TextEditingController();
  final TextEditingController accommodationRequiredController =
      TextEditingController();
  ...
  void _initializeRegistration() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            const MainPage(), // Replace with your LoginPage class
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    List<TextFieldWidget> studentDetailsForm = [
      ...
      TextFieldWidget(
        controller:
            studentContactController, // Provide the TextEditingController
      ...
      TextFieldWidget(
        controller:
            studentRollNoController, // Provide the TextEditingController
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
                ...
                padding: const EdgeInsets.fromLTRB(
                    16, 0, 16, 0) // Make the button transparent/ Remove padding
                ),
    ...
    List<TextFieldWidget> additionalPreferencesForm = [
      TextFieldWidget(
        controller:
            foodPreferenceController, // Provide the TextEditingController
      ...
      TextFieldWidget(
        controller:
            accommodationRequiredController, // Provide the TextEditingController
                                ...
                                Form(
                                  ...
                                  child: widget.isAlumni
                                      ? buildRegistrationStep(
                                          'Alumni Details', alumniDetailsForm)
                                      : buildRegistrationStep('Student Details',
                                          studentDetailsForm),
                                ),
                                Form(
                                  key: verifyEmailformKey,
                                  child: buildRegistrationStep(
                                      'Verify Email Address', verifyEmailForm),
                                ),
                                Form(
                                  key: setPasswordformKey,
                                  child: buildRegistrationStep(
                                      'Set a Password', setPasswordForm),
                                ),
                                Form(
                                  key: additionalPreferencesformKey,
                                  child: buildRegistrationStep(
                                      'Student Additional Preferences',
                                      additionalPreferencesForm),
                                ),
                              ],
                            )),
                        const SizedBox(
